...
import systems.alexander.bellsandwhistles.block.custom.MetroWindowBlock;
...
public class ModBlocks {
    ...
    public static final Block ANDESITE_GRAB_RAILS = registerBlock("andesite_grab_rails",
            MetalGrabRailsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.LADDER).sound(SoundType.METAL).noOcclusion());
    ...
    public static final Block ANDESITE_BOGIE_STEPS = registerBlock("andesite_bogie_steps",
            MetalBogieStepsBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.LADDER).sound(SoundType.METAL).noOcclusion());
    ...
    public static final Block ANDESITE_DOOR_STEP = registerBlock("andesite_door_step",
            MetalStepBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.LADDER).sound(SoundType.METAL).noOcclusion());
    ...
    public static final Block HEADLIGHT = registerBlock("headlight",
            HeadlightBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.LANTERN).sound(SoundType.LANTERN));
    public static final Block ORNATE_IRON_TRAPDOOR = registerBlock("ornate_iron_trapdoor",
            TrainTrapdoorBlock::metal, BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).sound(SoundType.GLASS).noOcclusion());

    public static final Block STATION_PLATFORM = registerBlock("station_platform",
            PlatformBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.SMOOTH_STONE).sound(SoundType.STONE).noOcclusion());

    public static final Block METRO_CASING = registerBlock("metro_casing",
            Block::new, BlockBehaviour.Properties.ofFullCopy(Blocks.MOSSY_COBBLESTONE).sound(SoundType.METAL));
    ...
    public static final Block METRO_PANEL = registerBlock("metro_panel",
            PanelBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.MOSSY_COBBLESTONE).sound(SoundType.METAL).noOcclusion());
    ...
    public static final Block METRO_WINDOW = registerBlock("metro_window",
            MetroWindowBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.MOSSY_COBBLESTONE).sound(SoundType.METAL).noOcclusion());

    public static final Block METRO_TRAPDOOR = registerBlock("metro_trapdoor",
            TrainTrapdoorBlock::metal, BlockBehaviour.Properties.ofFullCopy(Blocks.MOSSY_COBBLESTONE).sound(SoundType.METAL).noOcclusion());
    public static final Block METAL_PILOT = registerBlock("metal_pilot",
            PilotBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion());
    ...
    private static <T extends Block> T registerBlock(String name, Function<BlockBehaviour.Properties, T> factory, BlockBehaviour.Properties properties) {
        Identifier id = Identifier.fromNamespaceAndPath(BellsAndWhistles.MOD_ID, name);
